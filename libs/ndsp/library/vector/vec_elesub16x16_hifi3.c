...
void vec_elesub16x16 (int16_t* restrict z, const int16_t* restrict x, const  int16_t* restrict y, int N)
{
...
#elif __REFC_OOB__
#include "math.h"
void vec_elesub16x16 (int16_t* restrict z, int16_t* restrict x, int16_t* restrict y, int N)
{
	int i;
