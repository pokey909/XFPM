...
void vec_elemax32x32 (int32_t* restrict z, const int32_t* restrict x, int32_t* restrict y, int N)
{
...
#elif __REFC_OOB__
#include "math.h"
void vec_elemax32x32 (int32_t* restrict z, int32_t* restrict x, int32_t* restrict y, int N)
{
	int i;
