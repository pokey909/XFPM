                    ...
                    int N)
{
  ...
  ae_int16x4  vx0h, vy0h, vch;
  ae_f16x4    vx0f, vy0f, vcf;
  ...
  for (n=0; n<(N>>2); n++)
  {
    ...
    vx0f = (vx0h);    vy0f = AE_MULFP16X4RAS(vx0f, vcf);    vy0h = (vy0f);
  ...
  for (n=0; n<(N&3); n++)
  {
    AE_L16_IP(vx0h,castxcc(ae_int16,px),sizeof(int16_t));
    vx0f = (vx0h);    vy0f = AE_MULFP16X4RAS(vx0f, vcf);    vy0h = (vy0f);
    AE_S16_0_IP(vy0h, castxcc(ae_int16,py) ,sizeof(int16_t));
  }
} /* vec_scale16x16() */
