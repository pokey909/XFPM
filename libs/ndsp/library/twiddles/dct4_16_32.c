...
static const complex_fract16 ALIGN(16) dct4_twd_32[]=
{
...
static const complex_fract16 ALIGN(16) dct3_32[]=
{
    {{32767,0    }},{{32610,3212 }},{{32138,6393 }},{{31357,9512 }},
    {{30274,12540}},{{28899,15447}},{{27246,18205}},{{25330,20788}}
};

static const complex_fract16 ALIGN(16) rfft_16[]=
{
    {{30274,12540}},{{23170,23170}},{{12540,30274}}
};

static const complex_fract16 ALIGN(16) fft_8[]=
{
    {{ 32767, 0    }},
    {{ 32767, 0    }},
    {{ 32767, 0    }},
