...
ALIGN(16) const int16_t  ifft_twd512[64*12]  = {
...
static const cint32_ptr seqifft_twd512[] = { (cint32_ptr)ifft_twd512, (cint32_ptr)ifft_twd128, (cint32_ptr)ifft_twd32, (cint32_ptr)ifft_twd8 };
