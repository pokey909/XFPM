                          ...
                          int wrIx, int D, int N, int M )
{
  ...
  for ( n=0; n<(N>>2); n++ )
  {
    ...
    for ( m=0; m<(M>>2)+1; m++ )
    {
      ...
      AE_MULAAFD32R_HH_LL(q0, t1, c1);

      AE_MULAAFD32R_HH_LL(q1, d0, c0);
      AE_MULAAFD32R_HH_LL(q1, d1, c1);

      AE_MULAAFD32R_HH_LL(q2, t3, c0);
      AE_MULAAFD32R_HH_LL(q2, t4, c1);

      AE_MULAAFD32R_HH_LL(q3, d3, c0);
      AE_MULAAFD32R_HH_LL(q3, d4, c1);
#else
