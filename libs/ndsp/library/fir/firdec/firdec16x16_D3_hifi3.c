                      ...
                      int wrIx, int D, int N, int M )
{
    ...
    for (n = 0; n < (N >> 2); n++)
    {
        ...
        for (m = 0; m < (M >> 2) + 1; m++)
        {
            ...
            {
                ae_f32x2 cc0, cc1;
                cc0 = AE_CVT32X2F16_32(c0);
                cc1 = AE_CVT32X2F16_10(c0);
                AE_MULAAD32X16_H3_L2(q0, cc0, d0);
                AE_MULAAD32X16_H1_L0(q0, cc1, d0);
                AE_MULAAD32X16_H3_L2(q1, cc0, d1);
                AE_MULAAD32X16_H1_L0(q1, cc1, d1);
                AE_MULAAD32X16_H3_L2(q2, cc0, d2);
                AE_MULAAD32X16_H1_L0(q2, cc1, d2);
                AE_MULAAD32X16_H3_L2(q3, cc0, d3);
                AE_MULAAD32X16_H1_L0(q3, cc1, d3);
            }            
        }
