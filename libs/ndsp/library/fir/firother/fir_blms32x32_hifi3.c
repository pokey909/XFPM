...

{
    ...
    ae_f64   q0, q1, q2, q3;
    ae_f32x2 x0, x1, x2;
    ae_f32x2 x0_l, x0_h, x1_l, x1_h, x2_l, x2_h;
    ae_f32x2 h0, h1;
    ae_f32x2 r0, r1;
    ae_f32x2 e0_low, e0_high;
    ...
    for (n = 0; n < (N >> 2); n++)
    {
        ...
        AE_L32_IP(t0, castxcc(ae_int32, X), 4);
        x0_h = (t0);
        AE_L32_IP(t0, castxcc(ae_int32, X), 4);
        x0_l = (t0);
        AE_L32_IP(t1, castxcc(ae_int32, X), 4);
        x1_h = (t1);
        AE_L32_IP(t1, castxcc(ae_int32, X), 4);
        x1_l = (t1);

        S = X;
        AE_L32_IP(t2, castxcc(ae_int32, S), 4);
        x2_h = (t2);
        AE_L32_IP(t2, castxcc(ae_int32, S), 4);
        x2_l = (t2);
        ...
        q0 = AE_MULF32R_HH(x0_h, h0);
        AE_MULAF32R_LL(q0, x0_l, h0);

        // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
        q1 = AE_MULF32R_LH(x0_l, h0);
        AE_MULAF32R_LL(q1, h0, x1_h);

        // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
        q2 = AE_MULF32R_HH(x1_h, h0);
        AE_MULAF32R_LL(q2, x1_l, h0);

        // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
        q3 = AE_MULF32R_LH(x1_l, h0);
        AE_MULAF32R_LL(q3, h0, x2_h);
        ...
        for (m = 0; m < (M >> 1) - 1; m++)
        {
            ...
            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            AE_MULAF32R_HH(q0, x0_h, h0);
            AE_MULAF32R_LL(q0, x0_l, h0);

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            AE_MULAF32R_LH(q1, x0_l, h0);
            AE_MULAF32R_LL(q1, h0, x1_h);

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            AE_MULAF32R_HH(q2, x1_h, h0);
            AE_MULAF32R_LL(q2, x1_l, h0);

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            AE_MULAF32R_LH(q3, x1_l, h0);
            AE_MULAF32R_LL(q3, h0, x2_h);
    ...
    //
    {
        ...
        {            
            ...
            q0 = AE_MULF32S_HH(e, y); 
            e = AE_ROUND32X2F64SASYM(q0, q0);
...

        {
            ...
            q0 = AE_MULF32S_HH(vrw, vxw);
            s_frac = AE_ROUND32X2F64SASYM(q0, q0);
            s_exp -= mu_exp; // -31..30
        }
    }
    ...
    //
    {
        ...
        for (n = 0; n < (M >> 2); n++)
        {
            ...
            AE_L32_IP(t0, castxcc(ae_int32, E), 4);
            e0_high = t0;
            AE_L32_IP(t0, castxcc(ae_int32, E), 4);
            e0_low = t0;

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            q0 = AE_MULF32R_HH(x0, e0_high);
            AE_MULAF32R_LL(q0, x0, e0_low);

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            q1 = AE_MULF32R_LL(x0, e0_high);
            AE_MULAF32R_LH(q1, e0_low, x1);

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            q2 = AE_MULF32R_HH(x1, e0_high);
            AE_MULAF32R_LL(q2, x1, e0_low);

            // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
            q3 = AE_MULF32R_LL(x1, e0_high);
            AE_MULAF32R_LH(q3, e0_low, x2);
            ...
            for (m = 0; m < (N >> 1) - 1; m++)
            {
                ...
                // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
                AE_MULAF32R_HH(q0, x0, e0_high);
                AE_MULAF32R_LL(q0, x0, e0_low);

                // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
                AE_MULAF32R_LL(q1, x0, e0_high);
                AE_MULAF32R_LH(q1, e0_low, x1);

                // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
                AE_MULAF32R_HH(q2, x1, e0_high);
                AE_MULAF32R_LL(q2, x1, e0_low);

                // Q16.47 <- Q16.47 + [ Q31*Q31 - 15 ] w/ symmetric rounding
                AE_MULAF32R_LL(q3, x1, e0_high);
                AE_MULAF32R_LH(q3, e0_low, x2);
