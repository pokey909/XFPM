    ...
    */
    {
            ...
            {
                {
                    ...
                    AE_L16X4_IP(y3, Y3, 8);
                    AE_L16X4_IP(x0, X0, +8);
                    xx0 = AE_CVT32X2F16_32(x0);
                    xx1 = AE_CVT32X2F16_10(x0);
                    
                    AE_MULAAD32X16_H3_L2(q0, xx0, y0);
                    AE_MULAAD32X16_H1_L0(q0, xx1, y0);
                    AE_MULAAD32X16_H3_L2(q1, xx0, y1);
                    AE_MULAAD32X16_H1_L0(q1, xx1, y1);
                    AE_MULAAD32X16_H3_L2(q2, xx0, y2);
                    AE_MULAAD32X16_H1_L0(q2, xx1, y2);
                    AE_MULAAD32X16_H3_L2(q3, xx0, y3);
                    AE_MULAAD32X16_H1_L0(q3, xx1, y3);
                    ...
                    AE_MULAAD32X16_H3_L2(q4, xx0, y0);
                    AE_MULAAD32X16_H1_L0(q4, xx1, y0);
                    AE_MULAAD32X16_H3_L2(q5, xx0, y1);
                    AE_MULAAD32X16_H1_L0(q5, xx1, y1);
                    AE_MULAAD32X16_H3_L2(q6, xx0, y2);
                    AE_MULAAD32X16_H1_L0(q6, xx1, y2);
                    AE_MULAAD32X16_H3_L2(q7, xx0, y3);
                    AE_MULAAD32X16_H1_L0(q7, xx1, y3);
                }
            }
            {
                ae_f32x2 xx0, xx1;
        ...
        if (n_iter & 4)
        {
            ...
            AE_L16X4_IP(x0, X0, +8);
            {
                ...
                xx0 = AE_CVT32X2F16_32(x0);
                xx1 = AE_CVT32X2F16_10(x0);
                q0 = AE_MULZAAD32X16_H3_L2(xx0, y0);
                AE_MULAAD32X16_H1_L0  (q0, xx1, y0);
                q1 = AE_MULZAAD32X16_H3_L2(xx0, y1);
                AE_MULAAD32X16_H1_L0  (q1, xx1, y1);
                q2 = AE_MULZAAD32X16_H3_L2(xx0, y2);
                AE_MULAAD32X16_H1_L0  (q2, xx1, y2);
                q3 = AE_MULZAAD32X16_H3_L2(xx0, y3);
                AE_MULAAD32X16_H1_L0  (q3, xx1, y3);
            }
    ...
    */
    {
        ...
        for (n = 0; n < (n_iter&~7); n += 8)
        {
            ...
            AE_LA16X4_IP(y0, ay0, Y0);
            AE_LA16X4_IP(y1, ay0, Y0);

            for (m = 0; m < ((M - 1 - n + 3)>>2) - 1; m++ )
            {
                AE_LA16X4_IP(y2, ay0, Y0);
                AE_L16X4_IP(x0, X0, +8);
                AE_MULAFQ16X2_FIR_3(q0, q1, y0, y1, x0);
                AE_MULAFQ16X2_FIR_1(q2, q3, y0, y1, x0);
                AE_MULAFQ16X2_FIR_3(q4, q5, y1, y2, x0);
                AE_MULAFQ16X2_FIR_1(q6, q7, y1, y2, x0);
                y0 = y1; y1 = y2;
            }
            AE_L16X4_IP(x0, X0, +8);
        ...
        if (n_iter & 4)
        {
            ...
            AE_MULFQ16X2_FIR_3(q0, q1, y0, y1, x0);
            AE_MULFQ16X2_FIR_1(q2, q3, y0, y1, x0);
            y0 = y1;
