...
void fir_xcorr16x16( int16_t * restrict r,
               ...
               int N, int M )
#if !(defined(AE_MULAFQ16X2_FIR_3) && defined(AE_MULAFQ16X2_FIR_1))
{
  //
  ...
  for ( n=0; n<(N>>3); n++ )
  {
    ...
    AE_L16X4_XC(t1, X, +8);
    // Q31<-Q15
    x0 = AE_CVT32X2F16_32(t0);
    x1 = AE_CVT32X2F16_10(t0);
    x2 = AE_CVT32X2F16_32(t1);
    x3 = AE_CVT32X2F16_10(t1);
    ...
    AE_L16X4_XC( t3, S, +8 );
    // Q31<-Q15
    x4 = AE_CVT32X2F16_32(t3);
    x5 = AE_CVT32X2F16_10(t3);
    ...
    AE_S16X4_IP(AE_ROUND16X4F32SASYM(temp0, temp1), R, 8); 
  ...
  if (N&4)
  {
    ...
    AE_L16X4_XC(t2, S, +8);
    //Q31<-Q15
    x2 = AE_CVT32X2F16_32(t2);
    x3 = AE_CVT32X2F16_10(t2);
