...
#if !(defined(AE_MULAAAAQ16))
{
    ...
    for (n = 0; n < (N >> 3); n++)
    {
        ...
        for (m = 0; m < (M >> 2); m++)
        {
            AE_L16X4_RIP(h0, H);
            AE_L16X4_IP(x0, X0, 8);
            hh0 = AE_CVT32X2F16_32(h0);
            hh1 = AE_CVT32X2F16_10(h0);

            AE_MULAAD32X16_H3_L2(q0, hh0, x0);
            AE_MULAAD32X16_H1_L0(q0, hh1, x0);
            AE_MULAAD32X16_H3_L2(q1, hh0, x1);
            AE_MULAAD32X16_H1_L0(q1, hh1, x1);
            AE_MULAAD32X16_H3_L2(q2, hh0, x2);
            AE_MULAAD32X16_H1_L0(q2, hh1, x2);
            AE_MULAAD32X16_H3_L2(q3, hh0, x3);
            AE_MULAAD32X16_H1_L0(q3, hh1, x3);
            ...
            AE_MULAAD32X16_H3_L2(q4, hh0, x0);
            AE_MULAAD32X16_H1_L0(q4, hh1, x0);
            AE_MULAAD32X16_H3_L2(q5, hh0, x1);
            AE_MULAAD32X16_H1_L0(q5, hh1, x1);
            AE_MULAAD32X16_H3_L2(q6, hh0, x2);
            AE_MULAAD32X16_H1_L0(q6, hh1, x2);
            AE_MULAAD32X16_H3_L2(q7, hh0, x3);
            AE_MULAAD32X16_H1_L0(q7, hh1, x3);
        }
    ...
    for (m = 0; m < (M >> 3); m++)
    {
        ...
        for (n = 0; n < (N >> 2); n++)
        {
            AE_L16X4_IP(e0, E,  8);
            AE_L16X4_IP(x0, X0, 8);
            ee0 = AE_CVT32X2F16_32(e0);
            ee1 = AE_CVT32X2F16_10(e0);
           
            AE_MULAAD32X16_H3_L2(q0, ee0, x0);
            AE_MULAAD32X16_H1_L0(q0, ee1, x0);
            AE_MULAAD32X16_H3_L2(q1, ee0, x1);
            AE_MULAAD32X16_H1_L0(q1, ee1, x1);
            AE_MULAAD32X16_H3_L2(q2, ee0, x2);
            AE_MULAAD32X16_H1_L0(q2, ee1, x2);
            AE_MULAAD32X16_H3_L2(q3, ee0, x3);
            AE_MULAAD32X16_H1_L0(q3, ee1, x3);
            ...
            AE_MULAAD32X16_H3_L2(q4, ee0, x0);
            AE_MULAAD32X16_H1_L0(q4, ee1, x0);
            AE_MULAAD32X16_H3_L2(q5, ee0, x1);
            AE_MULAAD32X16_H1_L0(q5, ee1, x1);
            AE_MULAAD32X16_H3_L2(q6, ee0, x2);
            AE_MULAAD32X16_H1_L0(q6, ee1, x2);
            AE_MULAAD32X16_H3_L2(q7, ee0, x3);
            AE_MULAAD32X16_H1_L0(q7, ee1, x3);
        }
        t0 = AE_TRUNCA32X2F64S(q0, q1, 17);
        t1 = AE_TRUNCA32X2F64S(q2, q3, 17);
        x0 = AE_ROUND16X4F32SASYM(t0, t1);
