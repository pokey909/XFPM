                ...
                int N, int M )
{
  ...
  for ( n=0; n<(N>>3); n++ )
  {
    ...
    AE_MULFD32X16X2_FIR_HH( q1, q0, x2, x1, y0 );
    AE_MULFD32X16X2_FIR_HH( q3, q2, x3, x2, y0 );
    AE_MULFD32X16X2_FIR_HH( q5, q4, x4, x3, y0 );
    AE_MULFD32X16X2_FIR_HH( q7, q6, x5, x4, y0 );

    // Q16.47 <- Q16.47 + [ Q31*Q15 + 1 ] + [ Q31*Q15 + 1 ]
    AE_MULAFD32X16X2_FIR_HL( q1, q0, x1, x0, y0 );
    AE_MULAFD32X16X2_FIR_HL( q3, q2, x2, x1, y0 );
    AE_MULAFD32X16X2_FIR_HL( q5, q4, x3, x2, y0 );
    AE_MULAFD32X16X2_FIR_HL( q7, q6, x4, x3, y0 );
    ...
    for ( m=0; m<(M>>2)-1; m++ )
    {
      ...
      // Q16.47 <- Q16.47 + [ Q31*Q15 + 1 ] + [ Q31*Q15 + 1 ]
      AE_MULAFD32X16X2_FIR_HH( q1, q0, x2, x1, y0 );
      AE_MULAFD32X16X2_FIR_HH( q3, q2, x3, x2, y0 );
      AE_MULAFD32X16X2_FIR_HH( q5, q4, x4, x3, y0 );
      AE_MULAFD32X16X2_FIR_HH( q7, q6, x5, x4, y0 );
