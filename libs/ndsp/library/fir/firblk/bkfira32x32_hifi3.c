                   ...
                   const int32_t * restrict  x, int N )
{
    ...
    ae_int32x2 c0, c1;
    ae_int32x2 c0_l, c0_h, c1_l, c1_h;
    ae_f64     q0, q1, q2, q3;
    ae_valign  x_align;
    int M, wrIx;
    int m, n;
    ...
    for (n = 0; n<(N >> 2); n++)
    {
        ...
        for (m = 0; m<(M >> 2); m++)
        {
            ...
            // Load the next 4 tap coefficients.
            // Q31
            AE_L32_IP(c0, castxcc(ae_int32, C), 4);
            c0_h = c0;
            AE_L32_IP(c0, castxcc(ae_int32, C), 4);
            c0_l = c0;
            AE_L32_IP(c1, castxcc(ae_int32, C), 4);
            c1_h = c1;
            AE_L32_IP(c1, castxcc(ae_int32, C), 4);
            c1_l = c1;

            // Q17.47 <- QQ17.47 + [ Q31*Q31 ] - 15 with asymmetric rounding
            AE_MULAF32R_HH(q0, t01, c0_h);
            AE_MULAF32R_LL(q0, t01, c0_l);
            AE_MULAF32R_HH(q0, t23, c1_h);
            AE_MULAF32R_LL(q0, t23, c1_l);

            AE_MULAF32R_LL(q1, t01, c0_h);
            AE_MULAF32R_LH(q1, c0_l, t23);
            AE_MULAF32R_LL(q1, t23, c1_h);
            AE_MULAF32R_LH(q1, c1_l, t45);

            AE_MULAF32R_HH(q2, t23, c0_h);
            AE_MULAF32R_LL(q2, t23, c0_l);
            AE_MULAF32R_HH(q2, t45, c1_h);
            AE_MULAF32R_LL(q2, t45, c1_l);

            AE_MULAF32R_LL(q3, t23, c0_h);
            AE_MULAF32R_LH(q3, c0_l, t45);
            AE_MULAF32R_LL(q3, t45, c1_h);
            AE_MULAF32R_LH(q3, c1_l, t67);
    ...
    if (N & 3)
    {
        ...
        for (m = 0; m<(M >> 2); m++)
        {
            ...
            AE_MULAF32R_LH(q1, t01, c0_h);
            AE_MULAF32R_LH(q1, c0_l, t23);
            AE_MULAF32R_LH(q1, t23, c1_h);
            AE_MULAF32R_LH(q1, c1_l, t45);
