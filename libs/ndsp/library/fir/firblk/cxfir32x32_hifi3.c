                   ...
                   const complex_fract32 * restrict  x, int N)
{
    ...
    for (n = 0; n<(N >> 1); n++)
    {
        ...
        for (m = 0; m<(M >> 1); m++)
        {
            ...
            AE_MULAF32R_HH(q0r, t0, c0_h);
            AE_MULAF32R_LL(q0r, t0, c0_l);
            AE_MULAF32R_HH(q0r, t1, c1_h);
            AE_MULAF32R_LL(q0r, t1, c1_l);

            AE_MULAF32R_HH(q1r, t1, c0_h);
            AE_MULAF32R_LL(q1r, t1, c0_l);
            AE_MULAF32R_HH(q1r, t2, c1_h);
            AE_MULAF32R_LL(q1r, t2, c1_l);

            AE_MULSF32R_LH(q0i, c0_l, t0);
            AE_MULAF32R_LL(q0i, t0, c0_h);
            AE_MULSF32R_LH(q0i, c1_l, t1);
            AE_MULAF32R_LL(q0i, t1, c1_h);

            AE_MULSF32R_LH(q1i, c0_l, t1);
            AE_MULAF32R_LL(q1i, t1, c0_h);
            AE_MULSF32R_LH(q1i, c1_l, t2);
            AE_MULAF32R_LL(q1i, t2, c1_h);
