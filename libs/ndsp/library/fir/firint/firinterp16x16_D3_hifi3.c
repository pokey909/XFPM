                            ...
                            int wrIx, int D, int N, int M)
{
    ...
    for (n = 0; n < (N >> 2); n++)
    {
        ...
        for (m = 0; m < (M >> 2) + 1; m++)
        {
            ...
            AE_MULAFQ16X2_FIR_3(q0, q3, d0, d1, c0);
            AE_MULAFQ16X2_FIR_3(q1, q4, d0, d1, c1);
            AE_MULAFQ16X2_FIR_3(q2, q5, d0, d1, c2);
            d0 = d1;
        }
        ...
        for (m = 0; m < (M >> 2) + 1; m++)
        {
            ...
            AE_MULAFQ16X2_FIR_1(q6, q9,  d0, d1, c0);
            AE_MULAFQ16X2_FIR_1(q7, q10, d0, d1, c1);
            AE_MULAFQ16X2_FIR_1(q8, q11, d0, d1, c2);
            d0 = d1;
        }
        ...
        t1 = AE_TRUNCA32X2F64S(q10, q11, 32);
        AE_SA16X4_IP(AE_ROUND16X4F32SASYM(t0, t1), y_align, castxcc(ae_int16x4, Y));
    }
