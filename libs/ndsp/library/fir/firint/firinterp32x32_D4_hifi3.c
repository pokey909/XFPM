                          ...
                          int wrIx, int D, int N, int M )
{
  ...
  for ( n=0; n<(N>>2); n++ )
  {
    ...
    for (d=0; d<D; d++)
    {
      ...
      AE_MULAAFD32R_HH_LL(q0, t01, c0);
      AE_MULAAFD32R_HH_LL(q0, t23, c1);

      AE_MULAAFD32R_HH_LL(q1, t12, c0);
      AE_MULAAFD32R_HH_LL(q1, t34, c1);

      AE_MULAAFD32R_HH_LL(q2, t23, c0);
      AE_MULAAFD32R_HH_LL(q2, t45, c1);

      AE_MULAAFD32R_HH_LL(q3, t34, c0);
      AE_MULAAFD32R_HH_LL(q3, t56, c1);
#else
