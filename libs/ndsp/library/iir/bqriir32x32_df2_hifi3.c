...
#ifndef AE_MULSSFD32R_HH_LL
      AE_MULSF32R_HH(q0, cf_a2a1, st);
      AE_MULSF32R_LL( q0, cf_a2a1, st );
#else
      AE_MULSSFD32R_HH_LL(q0, cf_a2a1, st);
#endif

      // y0 = b2*st[-2] + b1*st[-1]
      // Q17.46 <- Q17.46 + [ Q30*Q31 + 1 - 16 w/ sym. rounding ]
#ifndef AE_MULZAAFD32R_HH_LL
      y0 = AE_MULF32R_HH(cf_b2b1, st);
      AE_MULAF32R_LL( y0, cf_b2b1, st );
#else
      y0 = AE_MULZAAFD32R_HH_LL(cf_b2b1, st);
#endif
...
#else
      y1 = AE_MULZAAFD32R_HH_LL(cf_b2b1, st);
#endif
