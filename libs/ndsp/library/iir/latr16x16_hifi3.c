                        ...
                        int N, int M )
{
  ...
  for ( n=0; n<N; n++ )
  {
    ...
    dl2 = dl1;
    AE_MULAFC16RAS(dl2, r1, cf1);
    dl1 = dl0;
    AE_MULAFC16RAS(dl1, r0, cf0);
    dl0 = r0;
#else
    {
      ae_f32x2 t;
...
#if (XCHAL_HAVE_HIFI3Z)
    dl4 = dl3;
    AE_MULAFC16RAS(dl4, r3, sccf43);
    dl3 = dl2;
    AE_MULAFC16RAS(dl3, r2, cf2);
    dl2 = dl1;
    AE_MULAFC16RAS(dl2, r1, cf1);
    dl1 = dl0;
    AE_MULAFC16RAS(dl1, r0, cf0);
                        ...
                        int N, int M )
{
  ...
  for ( n=0; n<N; n++ )
  {
    ...
    AE_MULAFC16RAS(dl54, r43, cf43);
    AE_MULAFC16RAS(dl32, r21, cf21);
    AE_MULAFC16RAS(dl10, r0out, cf0);
    // Store the output sample
                        ...
                        int N, int M )
{
  ...
  for ( n=0; n<N; n++ )
  {
    ...
    AE_MULAFC16RAS(dl65, r54, cf54);
    AE_MULAFC16RAS(dl43, r32, cf32);
    AE_MULAFC16RAS(dl21, r10, cf10);
    dl0 = r10;
                        ...
                        int N, int M )
{
  ...
  for ( n=0; n<N; n++ )
  {
    ...
    for ( m=M-2; m>=0; m-- )
    {
      ...
      // Q30 <- Q30 + (Q14*Q15 + 1)
#if(0) //"if" was earlier designed specifically for HiFi3z, however, else part gives better performance on HiFi3z and also works on hifi3/3z both.
      {
        ae_f16x4 zero;
        zero = AE_ZERO16();
        cf0 = AE_SEL16_6543(cf0, zero);
