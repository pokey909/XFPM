               ...
               int M, int N, int P, int lsh )
{
    ...
    for (p = 0; p < (P >> 2); p++)
    {
        ...
        for (m = 0; m < M; m++)
        {
            ...
            for (n = 0; n < N; n += 4)
            {
                ...
                AE_LA16X4_IP(xx, vy0, px0);
                x0 = AE_SEXT32X2D16_32(xx);
                x1 = AE_SEXT32X2D16_10(xx);

                AE_MULAAD32X16_H3_L2(B0, x0, y0);
                AE_MULAAD32X16_H1_L0(B0, x1, y0);
                AE_MULAAD32X16_H3_L2(B1, x0, y1);
                AE_MULAAD32X16_H1_L0(B1, x1, y1);
                AE_MULAAD32X16_H3_L2(B2, x0, y2);
                AE_MULAAD32X16_H1_L0(B2, x1, y2);
                AE_MULAAD32X16_H3_L2(B3, x0, y3);
                AE_MULAAD32X16_H1_L0(B3, x1, y3);
            }
            ...
            pz0 = (ae_int16x4 *)XT_ADDX2(P - 4, (uintptr_t)pz0);

            px = (const ae_int16x4 *)XT_ADDX2(N, (uintptr_t)px);
        }
        z += 4;
        y += 4;
    }
    ...
    if (P & 3)
    {
        ...
        for (m = 0; m < M; m++)
        {
            ...
            AE_S16_0_X(t0, (ae_int16 *)pz, offs2);
            t2 = AE_SEL16_5432(t0, t0);
            AE_S16_0_X(t2, (ae_int16 *)pz, offs1);
            t2 = AE_SEL16_6543(t0, t0);
            AE_S16_0_X(t2, (ae_int16 *)pz, 0);

            pz = (ae_int16x4 *)XT_ADDX2(P, (uintptr_t)pz);
