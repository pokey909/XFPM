...
#else
                AE_MULAF32R_HH(B0, X0, C0);
                AE_MULAF32R_HH(B1, X0, C1);
                AE_MULAF32R_HH(B2, X1, C0);
                AE_MULAF32R_HH(B3, X1, C1);
                AE_MULAF32R_HH(B4, X2, C0);
                AE_MULAF32R_HH(B5, X2, C1);
                AE_MULAF32R_HH(B6, X3, C0);
                AE_MULAF32R_HH(B7, X3, C1);
                AE_MULAF32R_LL(B0, X0, C0);
                AE_MULAF32R_LL(B1, X0, C1);
                AE_MULAF32R_LL(B2, X1, C0);
                AE_MULAF32R_LL(B3, X1, C1);
                AE_MULAF32R_LL(B4, X2, C0);
                AE_MULAF32R_LL(B5, X2, C1);
                AE_MULAF32R_LL(B6, X3, C0);
                AE_MULAF32R_LL(B7, X3, C1);
#endif
            }
            /* format values */
