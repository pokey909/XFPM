...
#else
            AE_MULAF32R_HH(B0, X0, Y0);
            AE_MULAF32R_HH(B1, X1, Y0);
            AE_MULAF32R_HH(B2, X2, Y0);
            AE_MULAF32R_HH(B3, X3, Y0);
            AE_MULAF32R_LL(B0, X0, Y0);
            AE_MULAF32R_LL(B1, X1, Y0);
            AE_MULAF32R_LL(B2, X2, Y0);
            AE_MULAF32R_LL(B3, X3, Y0);
#endif
...
#else
            AE_MULAF32R_HH(B0, X0, Y1);
            AE_MULAF32R_HH(B1, X1, Y1);
            AE_MULAF32R_HH(B2, X2, Y1);
            AE_MULAF32R_HH(B3, X3, Y1);
            AE_MULAF32R_LL(B0, X0, Y1);
            AE_MULAF32R_LL(B1, X1, Y1);
            AE_MULAF32R_LL(B2, X2, Y1);
            AE_MULAF32R_LL(B3, X3, Y1);
#endif
        }
        px0 += 3 * (N / 2);
        px1 += 3 * (N / 2);
