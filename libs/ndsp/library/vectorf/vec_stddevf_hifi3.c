 ...
 */
/*  Vector Standard deviation: Standard deviation of entire Input vector
...
DISCARD_FUN(float32_t, vec_stddevf, ( const float32_t * restrict x, int N ))
#elif HAVE_VFPU

#if __HiFi3_3z_NDSP__

#if __PERF_OPT__
float32_t vec_stddevf ( const float32_t * restrict x, int N )
{
	xtfloatx2 xtt;
	const xtfloatx2 * px;
