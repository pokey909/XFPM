...
DISCARD_FUN(void, vec_elesubf, (float32_t* restrict z, const float32_t* restrict x, const float32_t* restrict y, int N))
#elif HAVE_VFPU

#if __HiFi3_3z_NDSP__
void vec_elesubf (float32_t* restrict z, const float32_t* restrict x, const float32_t* restrict y, int N)
{
...
#elif __REFC_OOB__
#include "math.h"
void vec_elesubf (float32_t* restrict z, float32_t* restrict x, float32_t* restrict y, int N)
{
	int i;
