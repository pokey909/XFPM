...
static int fft_core_s3(int32_t *y, int32_t *x, const tFftDescr* pDescr)
{
  ...
  //const ae_int16x4 * restrict p_twd2;
  int step_circ, lc;
  ...
  if (stride > 4)
  {
   ...
   // vT1 = AE_L16X4_I(p_twd2, 8);
    tw1 = AE_MOVINT16X4_FROMF16X4( AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, 8)) );
    vB3 = AE_SEL32_LH(vB3, vB3);
    vC0 = AE_ADD32S(vB0, vB1);

    /* First phase I2xDFT4 s*/
    /* 21 cycles per pipeline stage in steady state with unroll = 1 */
    for(lc=0; lc<((N>>3)-1); lc++)
    {
     // AE_L16X4_IP(vTL, p_twd2, 24);
     // vT0 = (vTL);
      tw0 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, 0)));
      p_twd += 3;
      tw2 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, -8)));
      ...
      vC1 = AE_MULFC32X16RAS_H(vC1, tw1);

      vA0 = AE_SRAI32(vA0, FIRST_STAGE_SCALE);
      vA1 = AE_L32X2_I(p_x1, 8);

      vC2 = AE_MULFC32X16RAS_H(vC2, tw2);
      vA2 = AE_SRAI32(vA2, FIRST_STAGE_SCALE);
      vA3 = AE_L32X2_I(p_x3, 8);

      vC3 = AE_MULFC32X16RAS_H(vC3, tw0);
      ...
      vC0 = AE_SRAS32(vC0);
      vA1 = AE_L32X2_I(p_x1, 8);
      vC1 = AE_MULFC32X16RAS_L(vC1, tw1);
      vC2 = AE_SUBADD32S(vB2, vB3);
      vA0 = AE_SRAI32(vA0, FIRST_STAGE_SCALE);
      vA2 = AE_L32X2_I(p_x2, 8);
      vC2 = AE_MULFC32X16RAS_L(vC2, tw2);
      vC3 = AE_ADDSUB32S(vB2, vB3);
      vA1 = AE_SRAI32(vA1, FIRST_STAGE_SCALE);
      vA3 = AE_L32X2_I(p_x3, 8);
      vC3 = AE_MULFC32X16RAS_L(vC3, tw0);
      vA2 = AE_SRAI32(vA2, FIRST_STAGE_SCALE);
      AE_S32X2_IP(vC0, p_x0, 8);
      vB0 = AE_ADD32S(vA0, vA2);
      vC1 = AE_SRAS32(vC1);
  ...
  while (stride > 16)
  {
    ...
    /* Inner phases I4xDFT4 */
    /* 37 cycles per pipeline stage in steady state with unroll=1 */
    for(lc=0; lc<(N>>4); lc++)  
    {
        ae_int32x2 tmp32x2; 
    ...
    //  FFT_BUTTERFLY_S3(I, 8,XC,step_circ);
      {
          tw1 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, 8)));
          tw2 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, 16)));
          AE_L32X2_XP(tmp32x2, p_twd, step_circ); 
          tw0 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(tmp32x2));
          vB0 = AE_ADD32S(vA0, vA2);
          vB3 = AE_SUB32S(vA1, vA3);
          vB2 = AE_SUB32S(vA0, vA2);
          vB1 = AE_ADD32S(vA1, vA3);
          ...
          vC1 = AE_SUB32S(vB0, vB1);
          vB3 = AE_SEL32_LH(vB3, vB3);
          vA0 = AE_L32X2_X(p_x0, 8);
          vC0 = AE_ADD32S(vB0, vB1);
          vC2 = AE_SUBADD32S(vB2, vB3);
          vA1 = AE_L32X2_X(p_x1, 8);
          vC1 = AE_MULFC32X16RAS_L(vC1, tw1);
          vC3 = AE_ADDSUB32S(vB2, vB3);
          vA2 = AE_L32X2_X(p_x2, 8);
          vC2 = AE_MULFC32X16RAS_L(vC2, tw2);
          vC0 = AE_SRAS32(vC0);
          vA3 = AE_L32X2_X(p_x3, 8);
          vC3 = AE_MULFC32X16RAS_L(vC3, tw0);
          vC1 = AE_SRAS32(vC1);
          AE_S32X2_XP(vC0, p_x0, 8);
          vC2 = AE_SRAS32(vC2);
          AE_S32X2_XP(vC1, p_x1, 8);
          vC3 = AE_SRAS32(vC3);
          AE_S32X2_XP(vC2, p_x3, 8);
          AE_S32X2_XP(vC3, p_x2, 8);
      }
      //FFT_BUTTERFLY_S3(X, step,XC,step_circ)
      {
          tw1 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, 8)));
          tw2 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(AE_L32X2_I(p_twd, 16)));
          AE_L32X2_XC(tmp32x2, p_twd, step_circ);
          tw0 = AE_MOVINT16X4_FROMF16X4(AE_MOVINT16X4_FROMF32X2(tmp32x2));
          vB0 = AE_ADD32S(vA0, vA2);
          vB3 = AE_SUB32S(vA1, vA3);
          vB2 = AE_SUB32S(vA0, vA2);
          ...
          vC1 = AE_SUB32S(vB0, vB1);
          vB3 = AE_SEL32_LH(vB3, vB3);
          vA0 = AE_L32X2_X(p_x0, step);
          vC0 = AE_ADD32S(vB0, vB1);
          vC2 = AE_SUBADD32S(vB2, vB3);
          vA1 = AE_L32X2_X(p_x1, step);
          vC1 = AE_MULFC32X16RAS_L(vC1, tw1);
          vC3 = AE_ADDSUB32S(vB2, vB3);
          vA2 = AE_L32X2_X(p_x2, step);
          vC2 = AE_MULFC32X16RAS_L(vC2, tw2);
          vC0 = AE_SRAS32(vC0);
          vA3 = AE_L32X2_X(p_x3, step);
          vC3 = AE_MULFC32X16RAS_L(vC3, tw0);
          vC1 = AE_SRAS32(vC1);
          AE_S32X2_XP(vC0, p_x0, step);
          vC2 = AE_SRAS32(vC2);
          AE_S32X2_XP(vC1, p_x1, step);
          vC3 = AE_SRAS32(vC3);
          AE_S32X2_XP(vC2, p_x3, step);
          AE_S32X2_XP(vC3, p_x2, step);
      }
    };
...
//#else
  //  if (N == 64)
  //      p_twd2 = (const ae_int16x4 *)fft_twd16;
   // else
    //    p_twd2 = NULL;
#endif
  //  WUR_AE_CBEGIN0( (uintptr_t)p_twd2 );
  //  WUR_AE_CEND0  ( (uintptr_t)(p_twd2)+4*12 );
  //  ae_int32x2 p_twd_end = (uintptr_t)p_twd + 4 * 12; 

    step_circ=24;
    /////////////////////////////////////////////////////////////////////
    /* Next to last phase I4xDFT4 */
    /* 36 cycles per pipeline stage in steady state with unroll=1 */
             ...
             //   FFT_BUTTERFLY_S3(X, step_fwd,XC,step_circ)
              {
                ...
                vC1 = AE_SUB32S(vB0, vB1);
                vB3 = AE_SEL32_LH(vB3, vB3);
                vA0 = AE_L32X2_X(p_x0, step_fwd);
                vC0 = AE_ADD32S(vB0, vB1);
                vC2 = AE_SUBADD32S(vB2, vB3);
                vA1 = AE_L32X2_X(p_x1, step_fwd);
                vC1 = AE_MULFC32X16RAS_L(vC1, tw1);
                vC3 = AE_ADDSUB32S(vB2, vB3);
                vA2 = AE_L32X2_X(p_x2, step_fwd);
                vC2 = AE_MULFC32X16RAS_L(vC2, tw2);
                vC0 = AE_SRAS32(vC0);
                vA3 = AE_L32X2_X(p_x3, step_fwd);
                vC3 = AE_MULFC32X16RAS_L(vC3, tw0);
                vC1 = AE_SRAS32(vC1);
                AE_S32X2_XP(vC0, p_x0, step_fwd);
                vC2 = AE_SRAS32(vC2);
                AE_S32X2_XP(vC1, p_x1, step_fwd);
                vC3 = AE_SRAS32(vC3);
                AE_S32X2_XP(vC2, p_x3, step_fwd);
                AE_S32X2_XP(vC3, p_x2, step_fwd);
            }
    };
    /////////////////////////////////////////////////////////////////////
    {
