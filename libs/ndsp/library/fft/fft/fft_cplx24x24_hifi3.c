...
//static ALIGN(16) const int32_t fft24x24_twd_r8[12] = {
...
/* Radix-4 stage , scaling without rounding */ 
#define FFT_BUTTERFLY_S1(_T,_step,_X, twd_step, _rnd)                     \
      {                                                            \
      vT2 = AE_L32X2F24_I(p_twd, 8);                               \
      vB3 = AE_SEL32_LH(vB3, vB3);                                 \
      ...
      AE_L32X2F24_##_X(vT1, p_twd, twd_step);                      \
      vA2 = AE_SUBADD32S(vB2, vB3);     vA2 = AE_SRAS32(vA2);      \
      vA0 = AE_L32X2F24_##_T(p_x0, _step);  vA0 = AE_ADD32S(vA0, rnd_val);                       \
      vA3 = AE_ADDSUB32S(vB2, vB3);     vA3 = AE_SRAS32(vA3);      \
...
#define FFT_BUTTERFLY_S1_LAST(_T,_step,_X,twd_step, _rnd)                     \
      {                                                                 \
      vT2 = AE_L32X2F24_I(p_twd, 8);                                    \
      vB3 = AE_SEL32_LH(vB3, vB3);                                      \
      vA1 = AE_SUB32S(vB0, vB1);    vA1 = AE_SRAS32(vA1);               \
...
#define FFT_BUTTERFLY_S1_T1F(_T,_step, _rnd)  \
      {                                         \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);     vA1 = AE_SRAS32(vA1);          \
        vC0 = AE_ADD32S(vB0, vB1);     vC0 = AE_SRAS32(vC0);          \
...
#define FFT_BUTTERFLY_S3_RND(_T,_step,_X,twd_step) \
      {                                        \
      vT2 = AE_L32X2F24_I(p_twd, 8);         \
      vB3 = AE_SEL32_LH(vB3, vB3);           \
...
#define FFT_BUTTERFLY_S3_LAST_RND(_T,_step,_X,twd_step) \
      {                                        \
      vT2 = AE_L32X2F24_I(p_twd, 8);         \
      vB3 = AE_SEL32_LH(vB3, vB3);           \
      vA1 = AE_SUB32S(vB0, vB1);   vA1 = AE_SRAI32R(vA1, 2);          \
...
#define FFT_BUTTERFLY_R4_S1(idx)          \
    {                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
...
#define FFT_BUTTERFLY_R4_shift2(idx)          \
    {                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
...
static void fft_cplx_24x24_lbut4_s3(int32_t *y, int32_t *x, int N)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        FFT_BUTTERFLY_R4_shift2(i0);
        FFT_BUTTERFLY_R4_shift2(i1);
        FFT_BUTTERFLY_R4_shift2(i2);
        FFT_BUTTERFLY_R4_shift2(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }
}

#define FFT_BUTTERFLY_R2_S1(idx)         \
{                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
...
static int fft_cplx_24x24_lbut2_s1(int32_t *y, int32_t *x, int N, int exp)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    int shift;
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        FFT_BUTTERFLY_R2_S1(i0);
        FFT_BUTTERFLY_R2_S1(i1);
        FFT_BUTTERFLY_R2_S1(i2);
        FFT_BUTTERFLY_R2_S1(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }
    return shift;
}

static int fft_cplx_24x24_lbut4_s1(int32_t *y, int32_t *x, int N, int exp)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    int shift;
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        FFT_BUTTERFLY_R4_S1(i0);
        FFT_BUTTERFLY_R4_S1(i1);
        FFT_BUTTERFLY_R4_S1(i2);
        FFT_BUTTERFLY_R4_S1(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }
    return shift;
}
...
static int fft_cplx_24x24_core_s1(int32_t *y, int32_t *x, const tFftDescr* pDescr, int exp)
{
  ...
  { // first iteration for pre-scaling
    ...
    for (lc = 0; lc<((N >> 2) - 1); lc++)
    {
        FFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
    };
    FFT_BUTTERFLY_S1_LAST(I, 2 * 4, XC, step_circ, rnd_val)
    stride  >>= 2;
    step_circ<<=2;
  ...
  while (stride > 16)
  {
    ...
    for(lc=0; lc<(N>>4); lc++) 
    {
      ...
      FFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
          FFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
          FFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
          FFT_BUTTERFLY_S1(X, step, XC, step_circ, rnd_val)
    };
  ...
  if (stride==16)
  {
    ...
    for(lc=0; lc<((N>>4)-1); lc++) 
    {
        FFT_BUTTERFLY_S1(X, step_fwd, XC, step_circ, rnd_val)
    ...
    FFT_BUTTERFLY_S1_LAST(X, step_fwd, XC, step_circ, rnd_val)
  ...
  if (stride==8)
  {
    ...
    */
    ...
    {
      vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
      FFT_BUTTERFLY_S1_T1F(I, 2 * 4, rnd_val)
      vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
      FFT_BUTTERFLY_S1_T1F(I, 14 * 4, rnd_val)
    };
    {
      vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
      FFT_BUTTERFLY_S1_T1F(I, 2 * 4, rnd_val)
  ...
  {
    case 2:
         scale += fft_cplx_24x24_lbut2_s1(y, x, N, exp);
      break;
    case 4:
        scale += fft_cplx_24x24_lbut4_s1(y, x, N, exp);
      break;
  }
 ...
 // if (stride > 4)
  ...
  while (stride > 16)
  {
    ...
    for(lc=0; lc<(N>>4); lc++) 
    {
      ...
      FFT_BUTTERFLY_S3_RND(I, 2*4, XC, step_circ);
      FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ);
      FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ);
      FFT_BUTTERFLY_S3_RND(X, step, XC, step_circ);
    };
  ...
  */
  if (stride == 16)
  {
    ...
    for(lc=0; lc<((N>>4)-1); lc++) 
    {
        ...
        FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ)
        FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ)
        FFT_BUTTERFLY_S3_RND(X, step_fwd, XC, step_circ)
    };
    {
      FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ)
      FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ)
      FFT_BUTTERFLY_S3_RND(I, 2 * 4, XC, step_circ)
      FFT_BUTTERFLY_S3_LAST_RND(X, step_fwd, XC, step_circ)
    }
