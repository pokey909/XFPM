...
//static ALIGN(16) const int32_t ifft24x24_twd_r8[12] = {
...
#define IFFT_BUTTERFLY_S1(_T,_step,_X,twd_step, _rnd)\
    {                                        \
        vT2 = AE_L32X2F24_I(p_twd, 8);         \
        vB3 = AE_SEL32_LH(vB3, vB3);           \
        vA1 = AE_SUB32S(vB0, vB1);    vA1 = AE_SRAS32(vA1);         \
        vT3 = AE_L32X2F24_I(p_twd, 16);        \
        vC0 = AE_ADD32S(vB0, vB1);    vC0 = AE_SRAS32(vC0);         \
        AE_L32X2F24_##_X(vT1, p_twd, twd_step); \
        vA2 = AE_ADDSUB32S(vB2, vB3); vA2 = AE_SRAS32(vA2);         \
        vA0 = AE_L32X2F24_##_T(p_x0, _step); vA0 = AE_ADD32S(vA0, rnd_val);  \
        vA3 = AE_SUBADD32S(vB2, vB3); vA3 = AE_SRAS32(vA3);         \
...
#define IFFT_BUTTERFLY_S1_LAST(_T,_step,_X,twd_step, _rnd)\
      {                                        \
      vT2 = AE_L32X2F24_I(p_twd, 8);         \
      vB3 = AE_SEL32_LH(vB3, vB3);           \
      vA1 = AE_SUB32S(vB0, vB1);    vA1 = AE_SRAS32(vA1);         \
...
#define IFFT_BUTTERFLY_S1_T1F(_T,_step, _rnd)\
      {                                        \
        vB3 = AE_SEL32_LH(vB3, vB3);           \
        vA1 = AE_SUB32S(vB0, vB1);    vA1 = AE_SRAS32(vA1);         \
        vC0 = AE_ADD32S(vB0, vB1);    vC0 = AE_SRAS32(vC0);         \
        vA2 = AE_ADDSUB32S(vB2, vB3); vA2 = AE_SRAS32(vA2);         \
        vA0 = AE_L32X2F24_##_T(p_x0, _step);  vA0 = AE_ADD32S(vA0, _rnd);                      \
        vA3 = AE_SUBADD32S(vB2, vB3); vA3 = AE_SRAS32(vA3);         \
        vMX = AE_MAXABS32S(vMX, vC0);          \
        vF1 = AE_MOVF24X2_FROMINT32X2(vA2);    \
        vC2 = AE_MULFC24RA(vF1, vT3);          \
...
#define IFFT_BUTTERFLY_S1_T1F_LAST(_T,_step, _rnd)\
      {                                        \
        vB3 = AE_SEL32_LH(vB3, vB3);           \
        vA1 = AE_SUB32S(vB0, vB1);    vA1 = AE_SRAS32(vA1);         \
        vC0 = AE_ADD32S(vB0, vB1);    vC0 = AE_SRAS32(vC0);         \
...
#define IFFT_BUTTERFLY_S3_0(_T,_step,_X,twd_step)\
      {                                        \
        ...
        vB3 = AE_SEL32_LH(vB3, vB3);           \
        AE_L32X2F24_##_X(vT1, p_twd, twd_step);\
        vA2 = AE_ADDSUB32S(vB2, vB3);  vA2 = AE_SRAI32R(vA2, 3);         \
        vF1 = AE_L32X2F24_##_T(p_x0, _step);   \
        vA0 = (vF1);                           \
        vA3 = AE_SUBADD32S(vB2, vB3);  vA3 = AE_SRAI32R(vA3, 3);         \
                    \
        vF1 = AE_MOVF24X2_FROMINT32X2(vA1);    \
...
#define IFFT_BUTTERFLY_S3(_T,_step,_X,twd_step)\
      {                                        \
        ...
        AE_L32X2F24_##_X(vT1, p_twd, twd_step);\
        vA2 = AE_ADDSUB32S(vB2, vB3);    vA2 = AE_SRAI32R(vA2, 2);          \
        vF1 = AE_L32X2F24_##_T(p_x0, _step);   \
        vA0 = (vF1);                           \
        vA3 = AE_SUBADD32S(vB2, vB3);    vA3 = AE_SRAI32R(vA3, 2);      \
        vF1 = AE_MOVF24X2_FROMINT32X2(vA1);    \
        vF0 = AE_MULFC24RA(vF1, vT2);          \
        vC1 = (vF0);                           \
        vF2 = AE_L32X2F24_##_T(p_x1, _step);   \
...
#define IFFT_BUTTERFLY_R2_S1(idx)         \
    {                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
...
#define IFFT_BUTTERFLY_R4_S1(idx)         \
    {                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
...
#define IFFT_BUTTERFLY_R2_SHIFT1(idx)         \
    {                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
...
#define IFFT_BUTTERFLY_R4_SHIFT2(idx)         \
    {                                  \
    vA1 = AE_L32X2F24_I(p_x0, 8);      \
    vA2 = AE_L32X2F24_I(p_x0, 16);     \
    vA3 = AE_L32X2F24_I(p_x0, 24);     \
    ...
    vA2 = AE_SRAI32R(vA2, 2);         \
    vA1 = AE_SRAI32R(vA1, 2);         \
    vA3 = AE_SRAI32R(vA3, 2);         \
    vF1 = AE_MOVF24X2_FROMINT32X2(vA0); \
    AE_S32X2F24_X(vF1, p_y0, idx);     \
    vF2 = AE_MOVF24X2_FROMINT32X2(vA1); \
    AE_S32X2F24_X(vF2, p_y1, idx);     \
...
static int ifft_cplx_24x24_lbut2_s1(int32_t *y, int32_t *x, int N, int exp)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    int shift;
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        IFFT_BUTTERFLY_R2_S1(i0);
        IFFT_BUTTERFLY_R2_S1(i1);
        IFFT_BUTTERFLY_R2_S1(i2);
        IFFT_BUTTERFLY_R2_S1(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }
    return shift; 
}

static int ifft_cplx_24x24_lbut4_s1(int32_t *y, int32_t *x, int N, int exp)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    int shift; 
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        IFFT_BUTTERFLY_R4_S1(i0);
        IFFT_BUTTERFLY_R4_S1(i1);
        IFFT_BUTTERFLY_R4_S1(i2);
        IFFT_BUTTERFLY_R4_S1(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }
    return shift; 
}

static void ifft_cplx_24x24_lbut2_s3(int32_t *y, int32_t *x, int N)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        IFFT_BUTTERFLY_R2_SHIFT1(i0);
        IFFT_BUTTERFLY_R2_SHIFT1(i1);
        IFFT_BUTTERFLY_R2_SHIFT1(i2);
        IFFT_BUTTERFLY_R2_SHIFT1(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }

}

static void ifft_cplx_24x24_lbut4_s3(int32_t *y, int32_t *x, int N)
{
    ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
    ae_f24x2    vF1, vF2;
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        // Read eight inputs, and perform radix4 decomposition            
        //----------------------------------------------------------------
        IFFT_BUTTERFLY_R4_SHIFT2(i0);
        IFFT_BUTTERFLY_R4_SHIFT2(i1);
        IFFT_BUTTERFLY_R4_SHIFT2(i2);
        IFFT_BUTTERFLY_R4_SHIFT2(i3);
        i0 = AE_ADDBRBA32(i3, ai);
    }
}
...
static int ifft_cplx_24x24_core_s1(int32_t *y, int32_t *x, const tFftDescr* pDescr, int exp)
{
  ...
  if (stride > 4)
  { // first iteration for pre-scaling
    ae_int32x2 rnd_val = AE_MOVDA32( ((exp>0) ? (1 << exp) >> 1: 0) );
    ...
    vA0 = AE_L32X2F24_I(p_x0, 0); vA0 = AE_ADD32S(vA0, rnd_val);
    vA1 = AE_L32X2F24_I(p_x1, 0);
    vA2 = AE_L32X2F24_I(p_x2, 0);
    vA3 = AE_L32X2F24_I(p_x3, 0);
    scale += exp;
    ...
    */
    ...
    for(lc=0; lc<((N>>2)-1); lc++) 
    {
        IFFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
    };
    IFFT_BUTTERFLY_S1_LAST(I, 2 * 4, XC, step_circ, rnd_val)
  ...
  while (stride > 16)
  {
    ...
    for(lc=0; lc<(N>>4); lc++) 
    {
        ...
        IFFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
        IFFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
        IFFT_BUTTERFLY_S1(X, step, XC, step_circ, rnd_val)
    };
  ...
  if (stride==16)
  {
    ...
    for(lc=0; lc<((N>>4)-1); lc++) 
    {	  
        IFFT_BUTTERFLY_S1(X, step_fwd, XC, step_circ, rnd_val)
        AE_L16_IP(vS, p_inc, 2);
        vS = AE_SLAI16S(vS, 2);
        IFFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
        IFFT_BUTTERFLY_S1(I, 2 * 4, XC, step_circ, rnd_val)
    ...
    IFFT_BUTTERFLY_S1_LAST(X, step_fwd, XC, step_circ, rnd_val)
  ...
  if (stride==8)
  {
    ...
    // "N/2", "N", "3N/2" half word                                    
    //-----------------------------------------------------------------
    ae_int32x2 rnd_val = AE_MOVDA32((1<<exp)>>1); 
    p_x0 = (ae_f24x2 *)x;
    p_x1 = p_x0 + (stride>>2);
    p_x2 = p_x1 + (stride>>2);
    p_x3 = p_x2 + (stride>>2);
    ...
    {
      vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
      IFFT_BUTTERFLY_S1_T1F(I, 2 * 4, rnd_val)
      vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
      IFFT_BUTTERFLY_S1_T1F(I, 14 * 4, rnd_val)
    };
    {
      vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
      IFFT_BUTTERFLY_S1_T1F(I, 2 * 4, rnd_val)
      vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
      IFFT_BUTTERFLY_S1_T1F_LAST(I, 14 * 4, rnd_val)
    }
  ...
  {
    case 2:
        scale += ifft_cplx_24x24_lbut2_s1(y, x, N, exp);
      break;
    case 4:
        scale += ifft_cplx_24x24_lbut4_s1(y, x, N, exp);
      break;
  }
...
static int ifft_cplx_24x24_core_s3 (int32_t *y, int32_t *x, const tFftDescr* pDescr)
{
  ...
  switch (stride)
  {
    case 2:
        scale ++; 
      ifft_cplx_24x24_lbut2_s3(y, x, N);
      break;
    case 4:
        scale += 2;
        ifft_cplx_24x24_lbut4_s3(y, x, N);
      break;
  }
