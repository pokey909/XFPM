...
/*
   NatureDSP Signal Processing Library. FFT part
    2-D Inverse Discrete Cosine Transform, Type II 
...
/* DCT twiddles */
static const int32_t ALIGN(16) twd_tbl[] =
{
...
int idct2d_16x8(uint8_t * y, int16_t * x, dct_handle_t h, int L, int scalingOpt)
{
    ...
    for (l=0;l<L;l++)
    {
        ...
        for (n=0;n<8;n++)
        {
            ...
            v0 = AE_SRAI16R(v0, 3);
            v1 = AE_SRAI16R(v1, 3);
            v0 = AE_MIN16(v0, AE_MOVDA16(255));
            v0 = AE_MAX16(v0, AE_MOVDA16(0));
            v1 = AE_MIN16(v1, AE_MOVDA16(255));
            v1 = AE_MAX16(v1, AE_MOVDA16(0));
            v0 = AE_SHORTSWAP(v0);
            v1 = AE_MOVINT16X4_FROMINT64(AE_SLAI64(AE_MOVINT64_FROMINT16X4(v1),8));
            x0 = AE_OR16(v0, v1);
            AE_S16X4_IP(x0, pY, 8*sizeof(uint8_t));
