...
/*
	...
	N		size of FFT
*/
static void dct_split_32x32(int32_t * z, const int32_t * y, const tdct2_twd *descr);
...
-------------------------------------------------------------------------*/
#if 0
DISCARD_FUN(int,dct_32x32,(int32_t   * y, int32_t   * x,dct_handle_t h, int scalingOpt))
#else
...
static void dct_split_32x32(int32_t * z, const int32_t * y, const tdct2_twd *descr)
{
  const ae_int32x2 * restrict p_y0, * restrict p_y1, * restrict p_cos, * restrict p_w;
