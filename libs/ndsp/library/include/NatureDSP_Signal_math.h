...
-------------------------------------------------------------------------*/
void vec_tan24x24 (int32_t * restrict y, const f24     * restrict x, int N);
...
-------------------------------------------------------------------------*/
void vec_atan24x24 (f24     * restrict z, const f24     * restrict x, int N);
...
f24 scl_atan2_24x24  (f24       y, f24       x);
