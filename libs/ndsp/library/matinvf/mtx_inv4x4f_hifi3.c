...
void mtx_inv4x4f(float32_t* x)
{
    ...
    for(k=0; k<4; k++)
    {
        ...
        __Pragma("no_reorder")
        {
            pAk  = (xtfloat *)(A+k*8);
            xtfloat c1,c2,c3;
            pAn1=(xtfloat*)pAk    ; { ae_int32x2 t; AE_L32_XC(t,castxcc(ae_int32,pAn1),8*sizeof(xtfloat)); }
            pAn2=(xtfloat*)pAn1   ; { ae_int32x2 t; AE_L32_XC(t,castxcc(ae_int32,pAn2),8*sizeof(xtfloat)); }
            pAn3=(xtfloat*)pAn2   ; { ae_int32x2 t; AE_L32_XC(t,castxcc(ae_int32,pAn3),8*sizeof(xtfloat)); }
