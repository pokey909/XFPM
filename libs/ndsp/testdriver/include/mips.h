...
typedef union tag_profiler_dataInp
{
  ...
  complex16_t     cint16[PROFILE_DATA_OUT_SIZE* 2];
  complex32_t     cint32[PROFILE_DATA_OUT_SIZE* 2];
...
#define PROFILE_INVERTED_FFT_NOSC(_cond, _verbose,_f_name,N, _f_arg, _file, _fmt, _norm)           \
if (IS_PRESENT(_f_name))                                            \
 {                                                                                  \
    PROFILE_INVERTED(_cond, _verbose,_f_name, _f_arg, _file, "N=" #N,_fmt, _norm)   \
 }                                                                                  \
