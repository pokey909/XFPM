...
tTestEngLoadFxn    te_loadFxn_vXvYvZc;         /* real/complex vector X (in),real/complex vector Y (in), complex vector Z (out) */
tTestEngLoadFxn    te_loadFxn_vXcvYrvZc;	   /* complex vector X (in), real vector Y (in), complex vector Z (out)   	   */
tTestEngLoadFxn    te_loadFxn_vXcsYrvZc; 	  /* complex vector X (in), real scalar Y (in), complex vector Z (out)   	   */
...
tTestEngProcessFxn te_processFxn_vZcvXcsYr;       /* vector Z (out), vector X (in), vector Y (in)                             */
