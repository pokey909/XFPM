...
{                                                                                                     \
  ...
  DO_TEST(&vec_cplx2real_multvf 	, "vec_cplx2real_multvf.seq", 1 );
  DO_TEST(&vec_cplx2real_multsf 	, "vec_cplx2real_multsf.seq", 1 );
  DO_TEST(&vec_cplx2cplx_multf  	, "vec_cplx2cplx_multf.seq", 1 );
  DO_TEST(&vec_cplx_Conjf  		, "vec_cplxConjf.seq", 1 );
              ...
              int errhExtendedTest, int isFull, int isVerbose, int breakOnError, int testBitexactness )
{
  ...
  testDefTbl[] =
  {
	...
	{
	 FUNC_LIST( (tTestEngTarget)&vec_cplx2real_multvf ),
	 TEST_DESC( FMT_CPLX|FMT_FLOAT32, 0 ,TE_DIM_NUM_1, TE_ALIGN_YES, &te_loadFxn_vXcvYrvZc, &te_processFxn_vZvXvY ) },
	{
	 FUNC_LIST( (tTestEngTarget)&vec_cplx2real_multsf ),
	 TEST_DESC( FMT_CPLX|FMT_FLOAT32, 0, TE_DIM_NUM_1, TE_ALIGN_YES, &te_loadFxn_vXcsYrvZc, &te_processFxn_vZcvXcsYr ) },
	{
	 FUNC_LIST( (tTestEngTarget)&vec_cplx2cplx_multf ),
	 TEST_DESC( FMT_CPLX|FMT_FLOAT32, 0, TE_DIM_NUM_1, TE_ALIGN_YES, &te_loadFxn_vXvYvZc, &te_processFxn_vZvXvY ) },
	{
	 FUNC_LIST( (tTestEngTarget)&vec_cplx_Conjf ),
	 TEST_DESC( FMT_CPLX|FMT_FLOAT32,0, TE_DIM_NUM_1, TE_ALIGN_YES, &te_loadFxn_vXvZc, &te_processFxn_vZvX ) },
    { 
