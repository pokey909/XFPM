...
#define TEST_DESC_STND( fmt, extraParam, align,fwdfft,invfft,getHandle )   {{ (fmt),(extraParam),NULL, TE_ARGNUM_1,(align), \
                                                     &te_create_fft, &te_destroy_fft, \
                                                     &te_load_fft, &fileProc_stnd_rfft },(tFrwTransFxn)fwdfft,(tInvTransFxn)invfft,getHandle}
