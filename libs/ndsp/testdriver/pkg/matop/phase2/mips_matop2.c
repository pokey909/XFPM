...
#define PROFILE_mpyf(cond,verb,M,N,P)          PROFILE_INVERTED(cond,verb,mtx_mpyf,(mips.out0.f32, mips.inp0.f32, mips.inp1.f32, M, N, P),fout,#M"x"#N" x "#N"x"#P,prf_maccycle, (N*M*P));
#define PROFILE_mpyf_fast(cond,verb,M,N,P)     PROFILE_INVERTED(cond,verb,mtx_mpyf_fast,(mips.out0.f32, mips.inp0.f32, mips.inp1.f32, M, N, P),fout,#M"x"#N" x "#N"x"#P,prf_maccycle, (N*M*P));
