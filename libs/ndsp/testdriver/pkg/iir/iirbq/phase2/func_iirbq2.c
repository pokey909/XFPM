...
int bqriirf_df1_groupDelay(void* t){ (void)t; return 0;}
int bqriirf_df2_groupDelay(void* t){ (void)t; return 0;}
int bqriirf_df2t_groupDelay(void* t){ (void)t; return 0;}
int bqciirf_df1_groupDelay(void* t){ (void)t; return 0;}
