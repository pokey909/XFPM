...
/* Allocate vectors and load the data set:
 * real/complex vector X (in),real/complex vector Y (in), complex vector Z (out) */
int te_loadFxn_vXvYvZc( tTestEngContext * context )
{
  int M, N, L;
  ...
  fmtX = context->desc->fmt;
  fmtY = ( ( context->desc->fmt & FMT_DTYPE_MASK ) | FMT_CPLX );
  fmtZ = ( ( context->desc->fmt & FMT_DTYPE_MASK ) | FMT_CPLX );

  return ( te_loadFxn_vXvYvZ_helper( context, fmtX, nElem, fmtY, nElem, fmtZ, nElem ) );
} /* te_loadFxn_vXvYvZc() */

/* Allocate vectors and load the data set:
 * real/complex vector X (in),real/complex vector Y (in), real vector U (in),
 * complex vector Z (out) */
int te_loadFxn_vXcvYrvZc( tTestEngContext * context )
{
  ...
  nElem = M*N*L;
  fmtX = context->desc->fmt;
  fmtY = ( ( context->desc->fmt & FMT_DTYPE_MASK ) | FMT_REAL );
  fmtZ = ( ( context->desc->fmt & FMT_DTYPE_MASK ) | FMT_CPLX );
 ...
 * real/complex vector X (in),real/complex vector Y (in), real vector U (in),
 * complex vector Z (out) */
int te_loadFxn_vXcsYrvZc( tTestEngContext * context )
{
  ...
  return ( te_loadFxn_vXvYvZ_helper( context, fmtX, nElemX, fmtY, nElemY, fmtZ, nElemZ ) );
